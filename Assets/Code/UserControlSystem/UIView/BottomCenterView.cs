...
namespace Code.UserControlSystem.UIView
{
    ...
    {
        public IObservable<int> CancelButtonsClicks => _cancelButtonsClicks; 
        ...
        private Subject<int> _cancelButtonsClicks = new Subject<int>();
        ...
        private void Init()
        {
            ...
            {
                var index = i;
                _buttons[i].onClick.AddListener(() => _cancelButtonsClicks.OnNext(index));
            }
        }
